// /api/tts.js — Vercel Edge Function (streams MP3 and sets CORS everywhere)
...
export default async function handler(req) {
  ...
  try {
    ...
    // Use ElevenLabs streaming endpoint to avoid long waits/timeouts
    const url = `https://api.elevenlabs.io/v1/text-to-speech/${voice}/stream?optimize_streaming_latency=0`;

    // Watchdog so platform 504 never kicks in
    ...
    // Stream the MP3 back with CORS headers
